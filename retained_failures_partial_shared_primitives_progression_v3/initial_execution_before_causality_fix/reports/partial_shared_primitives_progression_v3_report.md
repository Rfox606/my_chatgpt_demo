...
```json
{
  ...
  "predictor_evaluation": [
    {
      ...
      "shared_predictor_huber_mae": 0.027395751955561713,
      "persistence_mae": 0.025788844374826436,
      "mae_ratio_to_persistence": 1.0623101817739398,
      "relative_mae_improvement": -0.062310181773939766
    },
    {
      "dataset": "Exp2",
      "heldout_start_fraction": 0.7,
      "heldout_window_count": 846,
      "shared_predictor_huber_mae": 0.026244605805076347,
      "persistence_mae": 0.02715398159336728,
      "mae_ratio_to_persistence": 0.9665104071325931,
      "relative_mae_improvement": 0.033489592867406937
    }
  ],
  ...
  "continuous_by_dataset": [
    {
      "dataset": "Exp1",
      "count": 9115,
      "std": 3.0815803335919325
    },
    {
      "dataset": "Exp2",
      "count": 2817,
      "std": 7.737226855254145
    }
  ],
  "synthetic": {
  ...
  "predictor_hash": "0664710ca8a6ecb73308824e336fc8a68739670148a79b07c3bd463269523814"
}
```
