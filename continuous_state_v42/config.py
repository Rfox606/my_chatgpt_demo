...
class ContinuousStateV42Config:
    """Pre-registered, label-free parameters for consensus causal v4.2."""

    output_dir: str = "outputs_continuous_state_v42"
