...
class ContinuousStateV4Config:
    """Pre-registered, label-free parameters for the v4 experiment."""

    output_dir: str = "outputs_continuous_state_v4"
    ...
    velocity_windows_cycles: tuple[int, ...] = (20, 50, 100)
    volatility_window_cycles: int = 50
    evidence_confirm_cycles: int = 100
    evidence_reset_cycles: int = 25
