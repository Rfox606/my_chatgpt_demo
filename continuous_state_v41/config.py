...
class ContinuousStateV41Config:
    """Pre-registered, label-free parameters for robust causal v4.1."""

    output_dir: str = "outputs_continuous_state_v41"
